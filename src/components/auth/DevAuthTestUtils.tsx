...
export default function DevAuthTestUtils() {
  useEffect(() => {
    if (process.env.NODE_ENV === "development") {
      ...
      import("@/lib/utils/auth-test")
        .then(({ AuthTestUtils }) => {
          // Make it available globally for testing
          (window as unknown as Record<string, unknown>).AuthTestUtils =
            AuthTestUtils;
          console.log(
            "🧪 Auth test utils loaded. Use AuthTestUtils in console for testing token refresh.",
          );
